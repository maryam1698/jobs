...
<!-- Mirrored from paradigm-shift.ir/Jbdesks/dashboard/comp_employer_edit_profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2019 10:49:11 GMT -->

<head>
    <meta charset="utf-8" />
    <title>ویرایش پروفایل کارفرما</title>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                    <div class="emp_dashboard_sidebar jb_cover">
                        ...
                        <div class="emp_follow_link jb_cover">
                            <ul class="feedlist">
                                <li><a href="comp_employer_dashboard.php"><i class="fas fa-tachometer-alt"></i> داشبورد </a></li>
                                <li>
                                    <a href="<?= $type_user['permission'] === "0" ? './candidate_edit_profile.php' : './comp_employer_edit_profile.php' ?> "> ویرایش پروفایل</a>
                                </li>
                                <li><a href="comp_company_page.php"><i class="fas fa-file"></i>صفحه شرکت </a></li>
                                <li><a href="comp_employer_manage_jobs.php"><i class="fas fa-suitcase"></i>مدیریت مشاغل</a></li>
                                <li><a href="comp_applications.php"><i class="fas fa-mobile"></i>برنامه ها</a></li>
                                <li><a href="comp_post_new_job.php"><i class="fas fa-user-plus"></i>ارسال شغل جدید</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="jp_job_post_right_cont edit_profile_wrapper">
                                                ...
                                                <div class="width_50">
                                                    <input type="file" id="input-file-now-custom-233" name="avatar" class="dropify" data-height="90" /><span class="post_photo">مرور تصویر</span>
                                                </div>
                                            </div>
                                    </div>
                            ...
                            <div class="browse_img_banner jb_cover">
                                ...
                                <!-- <div class="jp_job_post_right_cont edit_profile_wrapper">
                                    <h4>JPEG یا PNG در اندازه 1920x300px کاور تصویر</h4>

                                    <div class="width_50">
                                        <input type="file" id="input-file-now-custom-2" class="dropify" data-height="90" /><span class="post_photo">مرور تصویر</span>
                                    </div>
                                </div> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="contect_form3">
                                            ...
                                            <input type="email" value="<?= isset($info['email_contact']) ? $info['email_contact'] : '' ?>" name="email_contact" placeholder="hr@wevstrot.com">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="contect_form3">
                                    ...
                                    if (isset($_POST['edit'])) {
                                        ...
                                        if ($uploadOk == 1) {
                                            ...
                                            $size_of_company = $_POST['size_of_company'];
                                            $email_contact = $_POST['email_contact'];
                                            $connection = mysqli_connect("localhost", "root", "", "jobdesk");
                                            $id = $info['id'];
                                            $query = "UPDATE  users SET
    full_name='$full_name',email='$email',email_contact='$email_contact',avatar='$avatar',phone='$phone',website='$website',about_job='$about_job',address='$address',country='$country',area='$area',city='$city',pastal_code='$pastal_code',size_of_company='$size_of_company'
      WHERE id='$id' ";

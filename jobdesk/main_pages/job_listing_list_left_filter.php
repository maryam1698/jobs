                    ...
                    <ul class="main_nav_ul">
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">خانه</a>
                            <!--<ul class="navi_2_dropdown">
                                <li class="parent">
                                    <a href="index.php"><i class="fas fa-square"></i>خانه 1 </a>
                                </li>
                                <li class="parent">
                                    <a href="index_II.php"><i class="fas fa-square"></i>خانه 2</a>
                                </li>
                                <li class="parent">
                                    <a href="index_III.php"><i class="fas fa-square"></i> خانه 3</a>
                                </li>
                        ...
                        <li class="has-mega gc_main_navigation"><a href="#" class="gc_main_navigation">صفحات</a>
                            <!-- <ul class="navi_2_dropdown">
                                <li class="parent">
                                    <a href="about_us.php"> <i class="fas fa-square"></i>درباره ما</a>
                                </li>
                                <li class="parent">
                                    <a href="companies.php"> <i class="fas fa-square"></i>شرکت ها</a>
                                </li>
                                <li class="parent">
                                    <a href="company_single.php"> <i class="fas fa-square"></i>شرکت تنها</a>
                                </li>
                                <li class="parent">
                                    <a href="error_page.php"><i class="fas fa-square"></i>صفحه ارور</a>
                                </li>
                                <li class="parent">
                                    <a href="login.php"><i class="fas fa-square"></i>ورود</a>
                                </li>
                                <li class="parent">
                                    <a href="pricing_table.php"><i class="fas fa-square"></i>جدول قیمت گذاری</a>
                                </li>
                                <li class="parent">
                                    <a href="sign_up.php"><i class="fas fa-square"></i>ثبت نام</a>
                                </li>
                                ...
                                <ul class="navi_2_dropdown">
                                    <li class="parent">
                                        ...
                                        <ul class="dropdown-menu-right">
                                            ...
                                            <li>
                                                <a href="../dashboard/candidate_favourite_job.php"> <i class="fas fa-square"></i>شغل موردعلاقه</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="../dashboard/pricing_plans.php"> <i class="fas fa-square"></i>برنامه های قیمت گذاری</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="parent">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; اهواز 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="jp_job_post_right_btn_wrapper jb_cover">
                                                        <ul>
                                                            ...
                                                            <li><a href="job_single.php">نیمه وقت</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        ...
                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; کاشان 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        ...
                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; شیراز 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">استخدام تحلیلگر نرم افزار</a></h4>

                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; تبریز 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">برنامه نویس اچ تی ام ال و css (تازه)</a></h4>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        ...
                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; اصفهان 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">برنامه نویس جاوااسکریپت (تازه)</a></h4>

                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; قزوین 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        ...
                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; تهران 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">طراح سایت (تازه)</a></h4>

                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; کیش 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">ادمین اینستاگرام </a></h4>
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#">طراح گرافیک (تازه)</a></h4>

                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; قم 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="job_listing_left_fullwidth job_listing_grid_wrapper jb_cover">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <div class="jp_job_post_right_cont">
                                                        <h4><a href="#"> طراح وب (تازه)</a></h4>

                                                        <ul>
                                                            <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                            <li><i class="flaticon-location-pointer"></i>&nbsp; اراک 455001</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="job_listing_left_fullwidth jb_cover">
                                        <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                                                ...
                                                <div class="jp_job_post_right_cont">
                                                    <h4><a href="#">استخدام کارشناس نرم‌افزار</a></h4>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; البرز 455001</li>


                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; رشت 455001</li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                                                ...
                                                <div class="jp_job_post_right_cont">
                                                    ...
                                                    <ul>
                                                        <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; مشهد 45500</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                                                ...
                                                <div class="jp_job_post_right_cont">
                                                    ...
                                                    <ul>
                                                        <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; کرج 455001</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                                                ...
                                                <div class="jp_job_post_right_cont">
                                                    ...
                                                    <ul>
                                                        <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; عسلویه 455001</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                                                ...
                                                <div class="jp_job_post_right_cont">
                                                    ...
                                                    <ul>
                                                        <li><i class="flaticon-cash"></i>&nbsp; 12هزار - 15هزار</li>
                                                        <li><i class="flaticon-location-pointer"></i>&nbsp; یاسوج 455001</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">

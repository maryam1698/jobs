        ...
        <div class="container-fluid">
            ...
            <div class="menu_btn_box header_btn jb_cover">
                ...
                <?php } else { ?>
                    <ul>
                        <li>
                            <a href="#" style="width: 200px;"><i class="flaticon-man-user"><?= isset($_SESSION['email']) ? $_SESSION['email'] : ""; ?></i>
                            </a>
                        </li>
                        <li>
            ...
            <div class="jb_navigation_wrapper">
                <div class="mainmenu d-xl-block d-lg-block d-md-none d-sm-none d-none">
                    <ul class="main_nav_ul">
                        ...
                        <li><a href="job_listing_list_left_filter.php" class="gc_main_navigation">لیست فرصت های شغلی</a>
                        </li>
                            ...
                            <ul class="navi_2_dropdown">
                                <li class="parent">
                                    ...
                                    <ul class="dropdown-menu-right">
                                        <li>
                                            <a href="../dashboard/candidate_applied_job.php"> <i class="fas fa-square"></i>شغل
                                                تاییده شده </a>
                                        </li>
                                        <li>
                                            <a href="../dashboard/candidate_dashboard.php"> <i class="fas fa-square"></i>
                                                داشبورد</a>
                                        </li>
                                        <li>
                                            <a href="<?= $type_user['permission'] === "0" ? './../dashboard/candidate_edit_profile.php' : './../dashboard/comp_employer_edit_profile.php ' ?> "> ویرایش پروفایل</a>
                                ...
                                <li class="parent">
                                    ...
                                    <ul class="dropdown-menu-right">
                                        <li>
                                            <a href="../dashboard/comp_applications.php"> <i class="fas fa-square"></i>برنامه
                                                ها </a>
                                        </li>
                                        <li>
                                            <a href="../dashboard/comp_company_page.php"> <i class="fas fa-square"></i> صفحه
                                                شرکت</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="../dashboard/comp_post_new_job.php"> <i class="fas fa-square"></i>ارسال
                                                شغل جدید</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="job_listing_left_side jb_cover">
                        ...
                        <div id="list" class="tab-pane active">
                            <div class="row">
                                ...
                                //Checking is user existing in the database or not
                                $query = "SELECT * FROM `jobs` where cat_type='it'";
                                $result = mysqli_query($connection, $query) or die(mysqli_error($connection));
                                                        ...
                                                        <div class="search_alert_box jb_cover">
                                                            ...
                                                            <form data-job-id="<?= $job['id'] ?>" method="post" enctype="multipart/form-data">
                                                                ...
                                                                if (isset($_POST['upload'])) {
                                                                    ...
                                                                    if ($uploadOk == 0) {
                                                                        // echo "فایل انتخاب شده به سرویس دهنده میزبان ارسال نشد <br />";
                                                                    } else {
                                                                        if (move_uploaded_file($_FILES["resume"]["tmp_name"], $target_file)) {
                                                                            // echo "پرونده " . basename($_FILES["avatar"]["name"]) .
                                                                            //     " با موفقیت به سرویس دهنده میزبان انتقال یافت  <br />";
                                                                        } else {
                                                                            // echo "خطا در ارسال فایل به سرویس دهنده میزبان رخ داده است <br />";
                                                                        }
                                                                    }
                                                                ...
                                                                ?>
                                                                            <script>
                                                                                location.href = "Developer_job_listing.php";
                                                                            </script>
                                                                <?php

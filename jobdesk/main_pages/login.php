                        ...
                        <div class="login_form_wrapper">
                            <form action="" method="post">
                                ...
                                <div class="form-group icon_form comments_form">
                                    ...
                                    <input type="password" name="password" class="form-control require" placeholder="رمزعبور *">
                                ...
                                <div class="dont_have_account jb_cover">
                                    <p>حساب کاربری ندارید؟ <a href="sign_up.php">ثبت نام</a></p>
                                </div>
                            </form>
                        </div>
...
<!-- Mirrored from paradigm-shift.ir/Jbdesks/main_pages/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Jul 2019 10:49:08 GMT -->

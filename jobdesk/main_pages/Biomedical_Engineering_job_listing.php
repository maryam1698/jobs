                    ...
                    <div class="job_listing_left_side jb_cover">
                        ...
                        <div id="list" class="tab-pane active">
                            <div class="row">
                                ...
                                //Checking is user existing in the database or not
                                $query = "SELECT * FROM `jobs` where cat_type='pezeshki'";
                                $result = mysqli_query($connection, $query) or die(mysqli_error($connection));
                        ...
                        <div class="job_filter_category_sidebar jb_cover">
                            ...
                            <div class="category_jobbox jb_cover">
                                ...
                                <p class="job_field">
                                    ...
                                    <label for="c031">مشاغل در تبریز
                                        <span>(458)</span>
                                    </label>
                                </p>
                                <p class="job_field">
                                    <input type="checkbox" id="c041" name="cb">
                                    <label for="c041">مشاغل در البرز
                                        <span> (1047)</span>
                                    </label>
                                </p>
                                <p class="job_field">
                                    <input type="checkbox" id="c051" name="cb">
                                    <label for="c051">مشاغل در قزوین <span> (124)</span> </label>
                                </p>
                                <div class="seeMore"><a href="#">مشاهده تمام دسته ها</a></div>
                            </div>
                        </div>
